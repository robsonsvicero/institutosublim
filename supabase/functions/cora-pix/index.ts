...
serve(async (req) => {
  ...
  try {
    ...
    const tokenResponse = await fetch('https://matls-clients.api.stage.cora.com.br/token', tokenOptions)
    ...
    const invoiceResponse = await fetch('https://matls-clients.api.stage.cora.com.br/v2/invoices', invoiceOptions)
